window.onload = function() {
    ...
    game.States.main = function() {
        this.create = function() {
            ...
            // Проверка времени окончания предыдущей игры
            var lastEndTime = localStorage.getItem('lastEndTime');
            var now = new Date().getTime();
            if (lastEndTime && now < parseInt(lastEndTime) + 2 * 60 * 60 * 1000) {
                alert('Игра будет доступна через два часа.');
                return;
            }
        ...
        this.refreshTime = function() {
            ...
            if (this.leftTime === 0) {
                ...
                localStorage.setItem('lastEndTime', new Date().getTime());
                ...
                fetch('/update_balance', {
                    ...
                    body: JSON.stringify({ user_id: userId, balance: score })
